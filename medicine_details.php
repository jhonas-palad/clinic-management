...
if(isset($_POST['submit'])) {
  ...
  $query = "INSERT into `medicine_details` (`medicine_name`, `total_capsules`) values ('$medicineName', '$total_capsules');";
  try {
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="update_medicine_details.php?medicine_id=<?php echo $row['id'];?>&medicine_detail_id=<?php echo $row['id'];?>&total_capsules=<?php echo $row['total_capsules'];?>" 
